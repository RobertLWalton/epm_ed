...
Another important fact about closes sets and their boundaries is:
...
let $r_0=p+\alpha'*(q-p)$.  Then $r_0$ is in $S$, for if it would not,
...
Date:         & Mon Nov 23 00:40:03 EST 2020
