...
\tt onf~pqrd & returns {\tt true} if and only if {\tt r} is on the
                \underline{finite} line {\tt pq}, \\
	      & assuming all coordinates have at most {\tt d} decimal places \\
\tt between~pquv & returns {\tt true} if and only if the directed
                   line {\tt pu} rotated \\
		 & counter-clockwise will line up with
		   the directed line {\tt pq} \\
		 & before it lines up with {\tt pv}; \\
...
Date:         & Wed Mar 10 15:38:05 EST 2021
