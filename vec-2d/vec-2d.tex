...
of each point in units of 1/72'nd inch (1pt).  The default is 6pt.
...
The text drawing command is:
\\[1ex]
\begin{tabular}{@{}l@{~~~~~}l@{~~~~~}l@{}}
\underline{Command} & \underline{Draws}
\\[1ex]
\tt \#!text p [color] opt text... &
    the text, positioned at point {\tt p} \\
\end{tabular}

Here {\tt opt} is `{\tt -}' for no options, or given that point
{\tt p = ($x$,$y$)}, is one or more of: \\
\hspace*{0.5in}\begin{tabular}{rl}
    \tt t & display about 0.5em below $y$ \\
    \tt b & display about 0.5em above $y$ \\
...
Date:         & Thu Dec 17 07:06:39 EST 2020
