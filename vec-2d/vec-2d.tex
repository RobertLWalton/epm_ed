...
\item What are the lines tangent to an ellipse that pass through
an external point, and where are the points that these lines contact the
ellipse?
...
ellipse with major axis $M$ and minor axis $m$.  Then
$L*C = E$.

This is important because of the following.

First, note that $L^{-1}$, the inverse of $L$, exists and is such that \\
...
$p$ and vector $v$, \\
\centerline{$S = \{ p+s*v : s~\mathrm{is~a~scalar}\}$} \\
\centerline{$\mathcal{L}*S
...
Date:         & Sat Nov  7 00:32:55 EST 2020
