...
\tt tangc crp  & returns a tangent point ({\tt t} in the picture) \\
...
\tt basec crp  & returns the base point ({\tt b} in the picture) \\
...
\tt intersectc crpq  & returns the intersection point
                       ({\tt s} in the picture) \\
               & of the infinite line {\tt pq} and the circle; \\
	       & of the two possibilities, the one to the right of \\
...
Date:         & Thu Nov  5 05:57:20 EST 2020
\end{tabular}
